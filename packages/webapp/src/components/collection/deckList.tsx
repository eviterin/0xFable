      ...
      <div className="w-full flex flex-col items-center p-3">
        ...
        {decks.map((deck, deckID) => (
          <button 
            ...
            className="w-full px-4 py-2 mb-2 border rounded-md text-gray-100 bg-purple-500 hover:bg-gray-500 font-bold text-center focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
          >
            {deck.name}
          </button>
        ))}
